...
!(function (e, t) {
  ...
  var qt = /%20/g,
    ...
    Ht = /([?&])_=[^&]*/,
    Ot = /^(.*?):[ \t]*([^\r\n]*)$/gm,
    Pt = /^(?:about|app|app-storage|.+|file|res|widget):$/,
    Mt = /^(?:GET|HEAD)$/,
    Rt = /^\/\//,
    It = {},
    Wt = {},
    ...
    addSwitcher(),
      ...
      jQuery(".skin-1").on("click", function () {
        return (
          ...
          jQuery(".header-ind .logo-header img").attr(
            "src",
            "images/logo-color-1.png"
          ),
          jQuery(".header-seo .logo-header img").attr(
            "src",
            "images/logo-color-1.png"
          ),
          !1
...
function getCookie(e) {
  for (
    var i = e + "=", r = decodeURIComponent(document.cookie).split(";"), s = 0;
    s < r.length;
    s++
  ) {
